...
(call/cc (lambda (ret) (
  ...
  (add_lwp (lambda () (producer ret "生产者1" 3)))
  (add_lwp (lambda () (producer ret "生产者2" 3)))

  (add_lwp (lambda () (consumer ret "消费者1" 1)))
  (add_lwp (lambda () (consumer ret "消费者2" 2)))
  (add_lwp (lambda () (consumer ret "消费者3" 2)))
