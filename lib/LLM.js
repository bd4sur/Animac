...
function init(PROCESS, RUNTIME) {
    ...
    let modelFileBase64 = _ANIMAC_NATIVE_UTILS.TrimQuotes(PROCESS.heap.Get(modelFileBase64Handle).content);
...
function new_session(PROCESS, RUNTIME) {
    ...
    let prompt = _ANIMAC_NATIVE_UTILS.TrimQuotes(PROCESS.heap.Get(promptHandle).content);
